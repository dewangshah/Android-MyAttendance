...
public class HodViewAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hod_view_attendance);
        bgTask backgrnd=new bgTask();
...
class bgTask extends AsyncTask<String, Void, String> {
    ...
    protected void onPreExecute() {
        json_url = "http://192.168.43.19/myattendance/json_get_data.php";
